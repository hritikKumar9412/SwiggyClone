    ...
    <header className="bg-[#ff5200] font-serif">
      <div className="flex justify-between container mx-auto py-8">
        ...
        <div className="text-white text-base font-bold flex gap-10 items-center">
          ...
          <a className="border border-black bg-black py-3 px-4 rounded-2xl" target="_blank" href="#">
            Sign in
          </a>
        </div>
      </div>
      ...
      <div className="pt-16 pb-8 relative">
        <img
          className="h-[450px] w-[250px] absolute top-0 left-0"
          src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/testing/seo-home/Veggies_new.png"
        />
        <img
          className="h-[450px] w-[250px] absolute top-0 right-0"
        ...
        <div className="max-w-[70%] container mx-auto flex gap-5 mt-10">
          <input
            className="bg-white w-[40%] text-xl px-5 py-4 rounded-2xl"
            placeholder="Enter your delivery location"
          />
          <input
            className="bg-white w-[55%] text-xl px-5 py-4 rounded-2xl"
